...
ALTER TABLE ALBUMS ADD CONSTRAINT albumsREFphotos FOREIGN KEY (COVER_PHOTO_ID) REFERENCES PHOTOS(PHOTO_ID) INITIALLY DEFERRED DEFERRABLE;
ALTER TABLE PHOTOS ADD CONSTRAINT photosREFalbums FOREIGN KEY (ALBUM_ID) REFERENCES ALBUMS(ALBUM_ID) INITIALLY DEFERRED DEFERRABLE;
